<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="addToCart.aspx.cs" Inherits="CVGS_Iteration_1.AddtoCart" %>
    ...
    <div align="center" style="margin: 0 auto;">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderColor="#333333" BorderWidth="5px" EmptyDataText="No Game available in shopping cart" Font-Bold="True" Height="257px" ShowFooter="True" Width="1100px" OnRowDeleting="GridView1_RowDeleting">
            <Columns>
                ...
                <asp:ImageField DataImageUrlField="gImage" HeaderText="Game Image">
                    <ControlStyle Height="300px" Width="340px" />
                    <ItemStyle HorizontalAlign="Center" />
                </asp:ImageField>
                <asp:BoundField DataField="gName" HeaderText="Game Name">
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
