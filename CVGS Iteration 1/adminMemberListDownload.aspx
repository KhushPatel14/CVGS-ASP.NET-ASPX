<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminMemberListDownload.aspx.cs" Inherits="CVGS_Iteration_1.adminMemberListDownload" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="server">

    <div align="center">
        <asp:Button ID="Button1" runat="server" Text="Download All Member" BackColor="Silver" Font-Bold="True" Font-Size="Large" Height="49px" OnClick="Button1_Click" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <table border="1">
                <tr>
                    <td style="text-align: center">
                        <h2 style="text-align: center">All Member List</h2>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td align="Center">All Member List!</td>
                </tr>
                <tr>
                    <td></td>
                </tr>
